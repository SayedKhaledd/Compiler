...
public class startParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		public TerminalNode TYPE() { return getToken(startParser.TYPE, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof startListener ) ((startListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof startListener ) ((startListener)listener).exitStart(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof startVisitor ) return ((startVisitor<? extends T>)visitor).visitStart(this);
